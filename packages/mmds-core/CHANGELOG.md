...
- correct repository URL in npm package.json files - ([0d78274](https://github.com/kevinswiber/mmdflux/commit/0d78274c68ea5d1c9fab0d69752d7671d12fdcaa)) - [@kevinswiber](https://github.com/kevinswiber)

- - -

## [mmds-core-v0.2.0](https://github.com/kevinswiber/mmdflux/compare/126b2f9a070f374714a0970f5b3d565db6001969..mmds-core-v0.2.0) - 2026-04-04
#### Features
...
Initial release. Core MMDS types, serialization, and hydration utilities for
converting mmdflux geometry output into adapter-friendly structures.
